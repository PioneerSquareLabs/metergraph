...
duplicate identifiers or physical routes, malformed routes, route
provider/channel mismatches, and offer groups whose credentials or providers do
not match their declared routing path fail closed with `ModelRegistryError`.
